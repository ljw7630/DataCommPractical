...
void SortPairsByValue(const vector< vector< vector<double> > > &Residual_Signal_Strength_Surfaces, int No_Residual_Surfaces, int No_Grps);
...
void localization ()
{
	...
	****************************************************************************************/
	...
	for(Tuple_No=0;(Tuple_No<=No_Residual_Surfaces-1)&&(Tuple_No !=6);Tuple_No++)
	{
		...
		for(Y_Index=0; Y_Index<=49; Y_Index++)
		{
			...
			***********************************************************************************************************************************/
			...
			// comment out the output to speed up
	...
	SortPairsByValue(Residual_Signal_Strength_Surfaces, No_Residual_Surfaces, No_Grps);
